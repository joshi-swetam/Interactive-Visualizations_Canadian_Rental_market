...
.then(
  function(locations)
  { 
    province_centers = locations;
    // console.log(locations)

  // Loop through locations, and create the markers.
  for (let i = 0; i < locations.length; i++) {
    let lat = locations[i].Filters.CenterGeo.Lat;
    let lon = locations[i].Filters.CenterGeo.Lon;
    // console.log(locations[i].Filters.CenterGeo.Lat)
    cordinates = [lat,lon];
